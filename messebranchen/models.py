...
class Branchen(models.Model):
    b_id = models.ForeignKey("self", on_delete=models.RESTRICT)
    sprach_id = models.ForeignKey(Languages, on_delete=models.RESTRICT)
    ...
    small_img = models.ImageField(upload_to=upload_file_name,  null=True)
    big_img = models.ImageField(upload_to=upload_file_name, blank=True, null=True)
